...
export default function FeatureCard({
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col h-full transform transition-all duration-300 hover:translate-y-[-5px] hover:shadow-xl overflow-hidden">
      <div className="h-48 bg-slate-200 relative">
        {/* Placeholder for feature image */}
        <div className="absolute inset-0 flex items-center justify-center text-slate-400 rounded">
          {title === "Story Maps" && (
            <Image
      ...
      <div className="p-6">
        ...
        <Button
          variant="default"
          className="w-full text-md py-6 transition-all duration-300 hover:translate-y-[-2px]"
        >
          {buttonText}
        </Button>
      </div>
