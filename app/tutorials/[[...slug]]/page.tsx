...
export default function TutorialsPage() {
  const [selected, setSelected] = useState("beginners");
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <Tabs defaultValue="beginners" className="w-full max-w-4xl mx-auto">
            ...
            <div
              className="mt-4 text-center p-3"
              style={{ backgroundColor: colors.cream }}
            >
              <TabsContent
                value="beginners"
              ...
              <TabsContent
                ...
                style={{ color: colors.navy }}
              >
                Detailed instructions for tracing family connections to
              ...
              <TabsContent
                ...
                style={{ color: colors.navy }}
              >
                Techniques for cross-referencing historical records, treaties,
                and modern boundaries.
              </TabsContent>
              {/* Detailed Instructions */}
              <TabsContent value="beginners" className="mt-4 text-center">
                        ...
                        <div className="md:flex">
                          ...
                          <CardContent className="p-6 md:w-3/4">
                            ...
                            <ul className="space-y-3 text-gray-700">
                              <li>
                                • Click on the "Story Maps" option in the main
                                navigation menu at the top of the page
                              </li>
                              <li>
                                • Select "Native Land Allotment Map" from the
                                dropdown menu
                              </li>
                              <li>
                                • The interactive map will load with a default
                                view of the continental United States
                              </li>
                              <li>
                                • For best performance, use Chrome, Firefox, or
                                Edge browsers
                              </li>
                            </ul>
                          </CardContent>
                      ...
                      >
                        <div className="md:flex">
                          ...
                          <CardContent className="p-6 md:w-3/4">
                            ...
                            <ul className="space-y-3 text-gray-700">
                              <li>
                                • Find the "Map Layers" panel on the left side
                                of your screen
                              </li>
                              <li>
                                • Toggle between different historical periods
                                using the timeline slider (1830-1950)
                              </li>
                              <li>
                              ...
                              <li>
                                • Use the opacity slider to adjust layer
                                transparency when viewing multiple layers
                              </li>
                            </ul>
                          </CardContent>
                        </div>
                            ...
                            <ul className="space-y-3 text-gray-700">
                              ...
                              <li>
                                ...
                                <ul className="ml-6 mt-2 space-y-2">
                                  ...
                                  <li>
                                    - Tribal affiliation (e.g., "Cherokee,"
                                    "Lakota," "Navajo")
                                  </li>
                                  <li>
                                    - Geographic location (county, state, or
                                    region)
                                  </li>
                                  <li>
                                    - Allotment number (if known from family
                                    records)
                                  </li>
                              ...
                              <li>
                                • The map will zoom to relevant locations
                              ...
                              <li>
                                • Try alternative spellings if initial searches
                                don't yield results
                              </li>
                            </ul>
                          </CardContent>
                      ...
                      >
                        <div className="md:flex">
                          ...
                          <CardContent className="p-6 md:w-3/4">
                            ...
                            <ul className="space-y-3 text-gray-700">
                              <li>
                                • Click directly on any highlighted area of the
                                map to open the information panel
                              </li>
                              <li>
                                • The information panel provides:
                                <ul className="ml-6 mt-2 space-y-2">
                                  <li>
                                    - Original allotment details (date, acreage,
                                    legal description)
                                  </li>
                                  <li>
                                    - Name of original allottee and tribal
                                    affiliation
                                  </li>
                                  <li>
                              ...
                              <li>
                                • Toggle between "Historical View" and "Modern
                                View" to see how boundaries have changed
                              </li>
                              <li>
                                • Click "Save to Research" to bookmark this
                      ...
                      >
                        <div className="md:flex">
                          ...
                          <CardContent className="p-6 md:w-3/4">
                            ...
                            <ul className="space-y-3 text-gray-700">
                              <li>
                                • From any allotment information panel, click
                              ...
                              <li>
                                ...
                                <ul className="ml-6 mt-2 space-y-2">
                                  ...
                                  <li>
                                    - Correspondence between agents and tribal
                                    members
                                  </li>
                                  <li>
                              ...
                              <li>
                                • Use the document viewer to zoom, rotate, and
                                examine details
                              </li>
                              <li>
                                • Click "Download" to save high-resolution
                                copies for your research
                              </li>
                              <li>
                                • Note: Some documents require free registration
                                to access
                              </li>
                            </ul>
                          </CardContent>
                        ...
                        <div className="md:flex">
                          ...
                          <CardContent className="p-6 md:w-3/4">
                            ...
                            <ul className="space-y-3 text-gray-700">
                              ...
                              <li>
                                • Select "Create New Profile" to start
                                documenting your connections
                              </li>
                              <li>
                                • Add discovered allotments to your family tree
                                by clicking "Add to Profile" from any
                                information panel
                              </li>
                              <li>
                                • Upload additional family documents and
                                photographs to enhance your research
                              </li>
                              <li>
                                • Connect with others researching the same
                                allotments or family names
                              </li>
                              <li>
                                • Generate and download custom reports showing
                                your ancestral land connections
                              </li>
                              <li>
                                • Share your findings with family members via
